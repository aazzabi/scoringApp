...
$e = str_replace($search, $replace, utf8_encode(strtolower($etat)));
...
/*
 * si etat=="reglement judiciaire en cours" score=0 
 * sinon si etat=="cesse" score=1 
 * sinon si etat=="reglement amiable en cours" score=2
 * sinon si etat=="ratisage score"=3
 * sinon (actif) score=4 
 * */