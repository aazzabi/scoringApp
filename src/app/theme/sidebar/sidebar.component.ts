...
export const ROUTES: RouteInfo[] = [
  ...
  {path: '/creance', title: 'Creances', icon: 'pe-7s-note2', class: '', rolesAllowed: ['ADMIN', 'AGENT']},
  {path: '/contribuable', title: 'Contribuables', icon: 'fa pe fa-address-card-o', class: '', rolesAllowed: ['ADMIN' , 'AGENT']},
